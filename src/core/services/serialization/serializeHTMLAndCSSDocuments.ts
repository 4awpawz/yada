...
export const serializeHTMLDocuments = async function(assets: Assets, buildFolderPath: string) {
...
export const serializeCSSDocuments = async function(assets: Assets, buildFolderPath: string) {
